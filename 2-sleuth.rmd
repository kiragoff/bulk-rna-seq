...
okay basically everything is differentially expressed (everything but one gene). time massive driving factor. try pairwise comparisons and filtering out low abundance transcripts
